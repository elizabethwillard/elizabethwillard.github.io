...
description: A walkthrough of a GitHub Actions CI/CD workflow that builds a Dockerized Streamlit app, pushes it to Amazon ECR, and deploys it behind an NGINX reverse proxy on EC2.
date: 2024-04-15
tags: [aws, github-actions, docker, ec2, devops]
