...
description: Part 2 of a series on computer architecture, tracing the historical evolution of x86/x64, ARM (32- and 64-bit), and the open-source RISC-V through to the processors powering modern devices.
date: 2024-11-10
tags: [computer-architecture, hardware, arm, risc-v, x86]
